...
void mecanumOdomCallback(const geometry_msgs::Twist::ConstPtr& mecanum_odom){
  vx = odom_kv * mecanum_odom->linear.x;
  vy = odom_kv * mecanum_odom->linear.y;
  vth = odom_kth * mecanum_odom->angular.z;
  receive_flag = 1;
}
